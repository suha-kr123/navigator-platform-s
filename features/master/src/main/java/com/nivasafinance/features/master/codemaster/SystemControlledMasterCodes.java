...
public final class SystemControlledMasterCodes {
    
    private SystemControlledMasterCodes() {
    }
    
    public static final String LEAD_DOCUMENT_MASTER = "LEAD_DOCUMENT_MASTER";
    public static final String LENDER_STAGE_MASTER = "LENDER_STAGE_MASTER";
    public static final String LENDER_REJECTION_REASON_MASTER = "LENDER_REJECTION_REASON_MASTER";
    ...
    public static final String LEAD_PROPERTY_DOCUMENT_TYPE_MASTER = "LEAD_PROPERTY_DOCUMENT_TYPE_MASTER";
