...
/**
 * Tracks WhatsApp notifications sent to leads (customers).
 * Stores WATI response data and webhook updates for message status tracking.
 */
@Entity
@Table(name = "n_lead_whatsapp_notification")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class LeadWhatsAppNotification extends AuditableEntity {
