...
interface LeadDocumentsService {
    fun addDocumentsToLead(leadId: UUID, taskId: UUID, addDocumentsToLeadRequest: DocumentRequest): LeadTaskDocumentsResponse
    fun getDocumentById(leadId: UUID, taskId: UUID, documentId: UUID): LeadTaskDocumentsResponse
    fun getLeadDocuments(leadId: UUID, paginationRequest: PaginationRequest): PaginatedResponse<LeadTaskDocumentsResponse>
    fun getTaskDocuments(leadId: UUID, taskId: UUID, paginationRequest: PaginationRequest): PaginatedResponse<LeadTaskDocumentsResponse>
    fun getAllLeadsDocuments(paginationRequest: PaginationRequest): PaginatedResponse<LeadTaskDocumentsResponse>
    fun verifyDocument(leadId: UUID, taskId: UUID, documentId: UUID, verifyDocumentRequest: DocumentVerificationRequest): LeadTaskDocumentsResponse
