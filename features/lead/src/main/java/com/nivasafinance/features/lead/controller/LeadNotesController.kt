...
class LeadNotesController(
    ...
    fun getNotesByLeadId(
    ...
    ): ResponseEntity<PaginatedResponse<LeadNotesResponse>> {
        ...
        val leadNotes = if (taskId != null) {
            leadNotesService.getTaskNotes(leadId, taskId, paginationRequest)
        } else {
            leadNotesService.getLeadNotes(leadId, paginationRequest)
        }
    ...
    fun patchNotesByLeadId(
        ...
        leadNotesService.patchNotesById(leadId, notesId, updateNotesRequest)
    ...
    fun deleteNotesByLeadId(
        ...
        leadNotesService.deleteNotesById(leadId, notesId)
        return ResponseEntity.noContent().build()
    }
}
