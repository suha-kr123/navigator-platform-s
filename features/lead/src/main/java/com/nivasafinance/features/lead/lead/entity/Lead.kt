package com.nivasafinance.features.lead.lead.entity
...
data class Lead(
    ...
    @Column(name = "preimerly_information", columnDefinition = "jsonb")
    var preimerlyInformation: LeadPreimerlyInformation?,
