...
class VoiceServiceIntegrationTest {
    ...
    @Test
    fun `makeCall should handle null entity name gracefully`() {
        // Given
    ...
    @Test
    fun `makeCall should handle null entity id gracefully`() {
        // Given
        val request = VoiceCallRequest(
            fromNumber = "+919876543210",
            toNumber = "+918765432109",
    ...
    @Test
    fun `makeCall should handle empty call sid in response`() {
        // Given
        val request = VoiceCallRequest(
            fromNumber = "+919876543210",
            toNumber = "+918765432109",
    ...
    @Test
    fun `getCallStatus should handle error response`() {
        // Given
        val callSid = "CA1234567890"
        val response = VoiceCallResponse(
            callSid = callSid,
    ...
    @Test
    fun `makeCall should handle call log creation with all fields`() {
        // Given
        val request = VoiceCallRequest(
            fromNumber = "+919876543210",
            toNumber = "+918765432109",
            exophone = "+911234567890",
            callPurpose = "Lead follow-up",
            entityName = "Lead",
            entityId = 123L
        )
    ...
    @Test
    fun `getCallStatus should handle call log update with all fields`() {
        // Given
        val callSid = "CA1234567890"
        val response = VoiceCallResponse(
            callSid = callSid,
